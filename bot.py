...
def handle_message(client, message):
    ...
    if '?gpt' in message.text:
        ...
        interim_message = app.send_message(message.chat.id, 'Processing...', reply_to_message_id=message.id)
        ...
        temp = new_temp
        app.send_message(message.chat.id, f'Temperature set to {temp}.', reply_to_message_id=message.id)

    elif '[]wtemp' in message.text:
        app.send_message(message.chat.id, f'Current temperature: {temp}.', reply_to_message_id=message.id)

    elif '[]rese' in message.text and message.from_user.id == admin_id:
        message_log = []
        app.send_message(message.chat.id, 'History reset.', reply_to_message_id=message.id)
